    ...
    <div class="footer-container">
      <div class="footer-column">
        ...
        <p>PharmaPTY optimiza el suministro de medicamentos en Panamá mediante soluciones tecnológicas que garantizan
          calidad y trazabilidad. Apoya a clínicas, hospitales y farmacias con una gestión eficiente del inventario. Su
          compromiso es brindar un servicio profesional enfocado en la salud pública.</p>
      </div>
      <div class="footer-column">
        <h3>Navegador</h3>
        <ul>
          ...
          <li><a href="contactus.jsp">Contáctanos</a></li>
        </ul>
      </div>
      <div class="footer-column">
